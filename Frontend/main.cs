    ...
    { bool stdin = filename=="-";
      ...
      { Parser parser;
        ...
        { Console.Error.WriteLine("Compiling...");
          ModuleGenerator.Generate(basename, outfile, AST.Create(parser.Parse()), exeType); // FIXME: if snippetmaker is used (eg, if eval is called), the snippets will be lost
